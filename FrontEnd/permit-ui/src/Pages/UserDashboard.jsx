...
const UserDashboard = () => {
  ...
  return (
    <div>
      <Navbar />
      <h1 className="text-2xl font-semibold text-center text-gray-800 mb-6 mt-4">
        User Dashboard
      </h1>
      ...
      <div className="mt-6 max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <button
          ...
          className="hover:bg-blue-600 w-full bg-blue-500 text-white py-2 rounded-md hover:cursor-pointer"
        >
          Create Permit
        </button>
      </div>

      <h1 className="text-2xl font-semibold text-center text-gray-800 mb-6 mt-6">
        Your Permits
      </h1>
